...
export default function Sidebar({
  ...
  return (
    <div className={`sidebar ${isOpen ? "open" : "closed"}`}>
      {/* Tombol toggle di sisi kanan sidebar */}
      <button className="toggle-btn left" onClick={() => setIsOpen(!isOpen)}>
        {isOpen ? "⮜" : "⮞"}
      </button>
        ...
        <div className="sidebar-content">
          ...
          <div className="filter-group">
            ...
            <select
              ...
              onChange={(e) =>
                onFilterChange({ ...filters, kategori: e.target.value })
              }
            >
          ...
          <div className="filter-group">
            ...
            <select
              ...
              onChange={(e) =>
                onFilterChange({ ...filters, kecamatan: e.target.value })
              }
            >
              <option value="">Semua</option>
          ...
          <div className="filter-group">
            ...
            <select
              value={filters.jenis}
              onChange={(e) =>
                onFilterChange({ ...filters, jenis: e.target.value })
              }
            >
              <option value="">Semua</option>
          ...
          <div className="filter-group">
            ...
            <input
              ...
              value={filters.nama}
              onChange={(e) =>
                onFilterChange({ ...filters, nama: e.target.value })
              }
          ...
          <div className="potensi-list">
            {data.length === 0 ? (
              ...
              data.map((item) => (
                <PotensiCard key={item.id} item={item} onSelect={onSelectNama} />
              ))
            )}
          </div>
        </div>
